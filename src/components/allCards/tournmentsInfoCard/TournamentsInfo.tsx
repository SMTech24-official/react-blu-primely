  ...
  return (
    <div className="lg:p-8 md:p-6 shadow-xl rounded-lg bg-card_bg">
      <div className="flex flex-col sm:flex-row md:flex-col lg:flex-row items-start justify-center lg:gap-6 md:gap-4 lg:mb-8 sm:gap-4 md:mb-6 mb-4">
        {imageSrc && (
          <div className="w-[150px] h-[200px] rounded-lg block">
            <img
              src={imageSrc}
              className="w-[150px] h-[180px] object-fill rounded-lg"
            />
            {status && (
              <div
        ...
        <div className="flex flex-col  w-full mt-8 sm:mt-0 ">
          <div className="flex lg:flex-row flex-col   lg:gap-0 gap-2 items-start justify-between">
            <div>
              <div className="space-y-2 ">
                <p className="text-lg font-semibold text-nowrap mr-3">
                  {title}
                </p>
                <p>Create At: {new Date(createdAt).toDateString()}</p>
              </div>
              <div className="flex items-center gap-2 mt-4">
                <p className="logo text-xs px-1 py-[2px] border uppercase">
                  {gameName}
                </p>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2 lg:space-y-3">
                ...
                <p className="flex 2xl:flex-row flex-col 2xl:items-center gap-1 text-gray-500 font-semibold ">
                  <span className="text-nowrap 2xl:pr-2 2xl:border-r">
                    Entry Fee: ${entryFee}
                  </span>{" "}
                  <span className="text-nowrap 2xl:pl-1">
                    Deadline:{" "}
                    {new Date(date)
          ...
          {teamSize && regions && skillLevel && (
            <div className="grid grid-cols-2  md:grid-cols-4 gap-4 text-sm my-6 w-full ">
