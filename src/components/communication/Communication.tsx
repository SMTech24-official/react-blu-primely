  ...
  return (
    <div className="flex flex-col ">
      <div className="h-full" >
        <div ref={containerRef} className="p-4 h-[65vh] md:h-[60vh] overflow-y-auto bg-scroll">
...
const MessageBubble: React.FC<MessageBubbleProps> = ({ message, role, colorScheme, userRole }) => {
  ...
  return (
    <div className={`flex relative ${isSender ? 'justify-end ' : 'justify-start'} mb-4`}>
      <div className={`flex items-start max-w-[70%] ${isSender ? 'flex-row-reverse ' : 'flex-row'}`}>
        <img className="w-10 h-10 rounded-full object-cover" src="https://img.freepik.com/free-photo/cartoon-man-wearing-glasses_23-2151136892.jpg?t=st=1738241888~exp=1738245488~hmac=53a101aae8483060e1456033a794e2e67f594075a577df2c4a42313470a52736&w=1380" alt="" />
        <div className={`mx-2 ${isSender ? 'text-right' : 'text-left'}`}>
          ...
          <div>
            <p className='text-slate-500 text-xs mx-4 mt-1'>Name</p>
          </div>
        </div>
      </div>
    </div>
