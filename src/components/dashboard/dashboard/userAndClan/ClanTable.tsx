...
export function ClanTable({ members, ClanLoading }: { members: Clan[] | null, ClanLoading: boolean }) {
    ...
    return (
        ...
        <div className="rounded-lg ">
            {
                members?.length > 0 ? <ScrollArea className="">
                    <Table>
                        <TableHeader>
                            <TableRow className="">
                        ...
                        <TableBody>
                            {members?.map((member: Clan) => (
                                ...
                                >
                                    ...
                                    <TableCell>{member.ClanStats.exp.toLocaleString()}</TableCell>
                                    <TableCell>${member.ClanStats.exp.toLocaleString()}</TableCell>
                                    <TableCell>
